...
class TestGcpEstateHistory:
    def test_timeline_returns_points_and_markers(
        self,
        gcp_user,
        gcp_service_factory,
        gcp_event_factory,
        gcp_incident_factory,
    ):
    ...
    def test_replay_snapshot_returns_summary_services_and_window_data(
        self,
        gcp_user,
        gcp_service_factory,
        gcp_event_factory,
        ...
        gcp_incident_factory(
            ...
            services_affected=["api"],
            regions_affected=["us-central1"],
        )

        resp = gcp_user.get(
            "/api/gcp-estate/replay-snapshot/",
            {
                "start": (now - timedelta(hours=2)).isoformat(),
                "end": now.isoformat(),
