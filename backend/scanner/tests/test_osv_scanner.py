...
from scanner.services.osv_scanner import _classify_severity, query_osv, _run_scan_pipeline, run_full_scan, run_local_scan
...
class TestRunFullScan:
    ...
    @patch("scanner.services.osv_scanner.get_dependency_files")
